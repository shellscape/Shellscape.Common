...
namespace Shellscape.UI.Controls.Preferences {
	...
	public partial class PreferencesButton : PreferencesButtonBase {
		...
		private PreferencesButtonItemCollection _buttonItems = new PreferencesButtonItemCollection();
		...
		public PreferencesButtonItemCollection ButtonItems {
		...
		private void buttonItems_SelectionChanged(object sender, PreferencesButtonItemEventArgs e) {
			if (ItemActivated != null) {
				ItemActivated(this, e);
			}
		}

		private void buttonItems_BeforeItemRemoved(object sender, PreferencesButtonItemEventArgs e) {
			if (_isExpanded) {
		...
		private void buttonItems_ItemAdded(object sender, PreferencesButtonItemEventArgs e) {
			UpdateItems(_isExpanded);
		}
